...
const Battle: React.FC = () => {
	const [playerOne, setPlayerOne] = React.useState<string>(null);
	const [playerTwo, setPlayerTwo] = React.useState<string>(null);
	...
	const handleReset = (id: 'playerOne' | 'playerTwo'): void =>
				...
				<div className="row space-around">
					{playerOne === null ? (
						...
						<PlayerPreview
							username={playerOne}
							label="Player One"
							onReset={(): void => handleReset('playerOne')}
						/>
					)}
					{playerTwo === null ? (
						<PlayerInput
						...
						<PlayerPreview
							username={playerTwo}
							label="Player Two"
							onReset={(): void => handleReset('playerTwo')}
						/>
					)}
				</div>
